...
import org.etsi.osl.controllers.tmf915.model.TopicDeleteEventPayload;
...
@Schema(name = "TopicDeleteEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class TopicDeleteEvent {

  private @Nullable TopicDeleteEventPayload event;
  ...
  public TopicDeleteEvent event(@Nullable TopicDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable TopicDeleteEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable TopicDeleteEventPayload event) {
    this.event = event;
  }

  public TopicDeleteEvent eventId(@Nullable String eventId) {
  ...
  public TopicDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public TopicDeleteEvent eventType(@Nullable String eventType) {
  ...
  public TopicDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public TopicDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public TopicDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public TopicDeleteEvent description(@Nullable String description) {
  ...
  public TopicDeleteEvent priority(@Nullable String priority) {
  ...
  public TopicDeleteEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public boolean equals(Object o) {
    ...
    TopicDeleteEvent topicDeleteEvent = (TopicDeleteEvent) o;
    return Objects.equals(this.event, topicDeleteEvent.event) &&
        Objects.equals(this.eventId, topicDeleteEvent.eventId) &&
        Objects.equals(this.eventTime, topicDeleteEvent.eventTime) &&
        Objects.equals(this.eventType, topicDeleteEvent.eventType) &&
        Objects.equals(this.correlationId, topicDeleteEvent.correlationId) &&
        Objects.equals(this.domain, topicDeleteEvent.domain) &&
        Objects.equals(this.title, topicDeleteEvent.title) &&
        Objects.equals(this.description, topicDeleteEvent.description) &&
        Objects.equals(this.priority, topicDeleteEvent.priority) &&
        Objects.equals(this.timeOcurred, topicDeleteEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopicDeleteEvent {\n");
