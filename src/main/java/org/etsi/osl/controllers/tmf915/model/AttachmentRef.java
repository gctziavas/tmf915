...
public class AttachmentRef {
  ...
  public AttachmentRef href(@Nullable URI href) {
    this.href = href;
    return this;
  }
  ...
  public AttachmentRef url(@Nullable URI url) {
    this.url = url;
    return this;
  }
  ...
  public AttachmentRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public AttachmentRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
