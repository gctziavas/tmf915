...
import org.etsi.osl.controllers.tmf915.model.EventCreateEventPayload;
...
@Schema(name = "EventCreateEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class EventCreateEvent {

  private @Nullable EventCreateEventPayload event;
  ...
  public EventCreateEvent event(@Nullable EventCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable EventCreateEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable EventCreateEventPayload event) {
    this.event = event;
  }

  public EventCreateEvent eventId(@Nullable String eventId) {
  ...
  public EventCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public EventCreateEvent eventType(@Nullable String eventType) {
  ...
  public EventCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public EventCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public EventCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public EventCreateEvent description(@Nullable String description) {
  ...
  public EventCreateEvent priority(@Nullable String priority) {
  ...
  public EventCreateEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public boolean equals(Object o) {
    ...
    EventCreateEvent eventCreateEvent = (EventCreateEvent) o;
    return Objects.equals(this.event, eventCreateEvent.event) &&
        Objects.equals(this.eventId, eventCreateEvent.eventId) &&
        Objects.equals(this.eventTime, eventCreateEvent.eventTime) &&
        Objects.equals(this.eventType, eventCreateEvent.eventType) &&
        Objects.equals(this.correlationId, eventCreateEvent.correlationId) &&
        Objects.equals(this.domain, eventCreateEvent.domain) &&
        Objects.equals(this.title, eventCreateEvent.title) &&
        Objects.equals(this.description, eventCreateEvent.description) &&
        Objects.equals(this.priority, eventCreateEvent.priority) &&
        Objects.equals(this.timeOcurred, eventCreateEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventCreateEvent {\n");
