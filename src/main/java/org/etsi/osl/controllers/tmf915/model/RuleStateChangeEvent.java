...
import org.etsi.osl.controllers.tmf915.model.RuleStateChangeEventPayload;
...
@Schema(name = "RuleStateChangeEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class RuleStateChangeEvent {

  private @Nullable RuleStateChangeEventPayload event;
  ...
  public RuleStateChangeEvent event(@Nullable RuleStateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable RuleStateChangeEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable RuleStateChangeEventPayload event) {
    this.event = event;
  }

  public RuleStateChangeEvent eventId(@Nullable String eventId) {
  ...
  public RuleStateChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public RuleStateChangeEvent eventType(@Nullable String eventType) {
  ...
  public RuleStateChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public RuleStateChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public RuleStateChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public RuleStateChangeEvent description(@Nullable String description) {
  ...
  public RuleStateChangeEvent priority(@Nullable String priority) {
  ...
  public RuleStateChangeEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public boolean equals(Object o) {
    ...
    RuleStateChangeEvent ruleStateChangeEvent = (RuleStateChangeEvent) o;
    return Objects.equals(this.event, ruleStateChangeEvent.event) &&
        Objects.equals(this.eventId, ruleStateChangeEvent.eventId) &&
        Objects.equals(this.eventTime, ruleStateChangeEvent.eventTime) &&
        Objects.equals(this.eventType, ruleStateChangeEvent.eventType) &&
        Objects.equals(this.correlationId, ruleStateChangeEvent.correlationId) &&
        Objects.equals(this.domain, ruleStateChangeEvent.domain) &&
        Objects.equals(this.title, ruleStateChangeEvent.title) &&
        Objects.equals(this.description, ruleStateChangeEvent.description) &&
        Objects.equals(this.priority, ruleStateChangeEvent.priority) &&
        Objects.equals(this.timeOcurred, ruleStateChangeEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class RuleStateChangeEvent {\n");
