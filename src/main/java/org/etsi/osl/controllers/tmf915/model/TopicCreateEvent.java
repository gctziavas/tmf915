...
import org.etsi.osl.controllers.tmf915.model.TopicCreateEventPayload;
...
@Schema(name = "TopicCreateEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class TopicCreateEvent {

  private @Nullable TopicCreateEventPayload event;
  ...
  public TopicCreateEvent event(@Nullable TopicCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable TopicCreateEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable TopicCreateEventPayload event) {
    this.event = event;
  }

  public TopicCreateEvent eventId(@Nullable String eventId) {
  ...
  public TopicCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public TopicCreateEvent eventType(@Nullable String eventType) {
  ...
  public TopicCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public TopicCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public TopicCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public TopicCreateEvent description(@Nullable String description) {
  ...
  public TopicCreateEvent priority(@Nullable String priority) {
  ...
  public TopicCreateEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public boolean equals(Object o) {
    ...
    TopicCreateEvent topicCreateEvent = (TopicCreateEvent) o;
    return Objects.equals(this.event, topicCreateEvent.event) &&
        Objects.equals(this.eventId, topicCreateEvent.eventId) &&
        Objects.equals(this.eventTime, topicCreateEvent.eventTime) &&
        Objects.equals(this.eventType, topicCreateEvent.eventType) &&
        Objects.equals(this.correlationId, topicCreateEvent.correlationId) &&
        Objects.equals(this.domain, topicCreateEvent.domain) &&
        Objects.equals(this.title, topicCreateEvent.title) &&
        Objects.equals(this.description, topicCreateEvent.description) &&
        Objects.equals(this.priority, topicCreateEvent.priority) &&
        Objects.equals(this.timeOcurred, topicCreateEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopicCreateEvent {\n");
