...
import org.etsi.osl.controllers.tmf915.model.MonitorDeleteEventPayload;
...
@Schema(name = "MonitorDeleteEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class MonitorDeleteEvent {

  private @Nullable MonitorDeleteEventPayload event;
  ...
  public MonitorDeleteEvent event(@Nullable MonitorDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable MonitorDeleteEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable MonitorDeleteEventPayload event) {
    this.event = event;
  }

  public MonitorDeleteEvent eventId(@Nullable String eventId) {
  ...
  public MonitorDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public MonitorDeleteEvent eventType(@Nullable String eventType) {
  ...
  public MonitorDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public MonitorDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public MonitorDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public MonitorDeleteEvent description(@Nullable String description) {
  ...
  public MonitorDeleteEvent priority(@Nullable String priority) {
  ...
  public MonitorDeleteEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
