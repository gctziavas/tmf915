...
import org.etsi.osl.controllers.tmf915.model.RuleCreateEventPayload;
...
@Schema(name = "RuleCreateEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class RuleCreateEvent {

  private @Nullable RuleCreateEventPayload event;
  ...
  public RuleCreateEvent event(@Nullable RuleCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable RuleCreateEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable RuleCreateEventPayload event) {
    this.event = event;
  }

  public RuleCreateEvent eventId(@Nullable String eventId) {
  ...
  public RuleCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public RuleCreateEvent eventType(@Nullable String eventType) {
  ...
  public RuleCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public RuleCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public RuleCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public RuleCreateEvent description(@Nullable String description) {
  ...
  public RuleCreateEvent priority(@Nullable String priority) {
  ...
  public RuleCreateEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public boolean equals(Object o) {
    ...
    RuleCreateEvent ruleCreateEvent = (RuleCreateEvent) o;
    return Objects.equals(this.event, ruleCreateEvent.event) &&
        Objects.equals(this.eventId, ruleCreateEvent.eventId) &&
        Objects.equals(this.eventTime, ruleCreateEvent.eventTime) &&
        Objects.equals(this.eventType, ruleCreateEvent.eventType) &&
        Objects.equals(this.correlationId, ruleCreateEvent.correlationId) &&
        Objects.equals(this.domain, ruleCreateEvent.domain) &&
        Objects.equals(this.title, ruleCreateEvent.title) &&
        Objects.equals(this.description, ruleCreateEvent.description) &&
        Objects.equals(this.priority, ruleCreateEvent.priority) &&
        Objects.equals(this.timeOcurred, ruleCreateEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class RuleCreateEvent {\n");
