...
@Schema(name = "AiContractSpecificationDeleteEventPayload", description = "The event data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class AiContractSpecificationDeleteEventPayload {

  private @Nullable AiContractSpecification aiContractSpecification;

  public AiContractSpecificationDeleteEventPayload aiContractSpecification(@Nullable AiContractSpecification aiContractSpecification) {
  ...
  public boolean equals(Object o) {
    ...
    AiContractSpecificationDeleteEventPayload aiContractSpecificationDeleteEventPayload = (AiContractSpecificationDeleteEventPayload) o;
    return Objects.equals(this.aiContractSpecification, aiContractSpecificationDeleteEventPayload.aiContractSpecification);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiContractSpecificationDeleteEventPayload {\n");
