...
import org.etsi.osl.controllers.tmf915.model.AiModelDeleteEventPayload;
...
@Schema(name = "AiModelDeleteEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class AiModelDeleteEvent {

  private @Nullable AiModelDeleteEventPayload event;
  ...
  public AiModelDeleteEvent event(@Nullable AiModelDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable AiModelDeleteEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable AiModelDeleteEventPayload event) {
    this.event = event;
  }

  public AiModelDeleteEvent eventId(@Nullable String eventId) {
  ...
  public AiModelDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public AiModelDeleteEvent eventType(@Nullable String eventType) {
  ...
  public AiModelDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public AiModelDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public AiModelDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public AiModelDeleteEvent description(@Nullable String description) {
  ...
  public AiModelDeleteEvent priority(@Nullable String priority) {
  ...
  public AiModelDeleteEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public boolean equals(Object o) {
    ...
    AiModelDeleteEvent aiModelDeleteEvent = (AiModelDeleteEvent) o;
    return Objects.equals(this.event, aiModelDeleteEvent.event) &&
        Objects.equals(this.eventId, aiModelDeleteEvent.eventId) &&
        Objects.equals(this.eventTime, aiModelDeleteEvent.eventTime) &&
        Objects.equals(this.eventType, aiModelDeleteEvent.eventType) &&
        Objects.equals(this.correlationId, aiModelDeleteEvent.correlationId) &&
        Objects.equals(this.domain, aiModelDeleteEvent.domain) &&
        Objects.equals(this.title, aiModelDeleteEvent.title) &&
        Objects.equals(this.description, aiModelDeleteEvent.description) &&
        Objects.equals(this.priority, aiModelDeleteEvent.priority) &&
        Objects.equals(this.timeOcurred, aiModelDeleteEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiModelDeleteEvent {\n");
