...
import org.etsi.osl.controllers.tmf915.model.FeatureSpecificationCharacteristicRelationship;
...
public class FeatureSpecificationCharacteristic {
  ...
  public FeatureSpecificationCharacteristic id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public FeatureSpecificationCharacteristic configurable(@Nullable Boolean configurable) {
  ...
  public FeatureSpecificationCharacteristic description(@Nullable String description) {
  ...
  public FeatureSpecificationCharacteristic extensible(@Nullable Boolean extensible) {
  ...
  public FeatureSpecificationCharacteristic isUnique(@Nullable Boolean isUnique) {
  ...
  public FeatureSpecificationCharacteristic maxCardinality(@Nullable Integer maxCardinality) {
  ...
  public FeatureSpecificationCharacteristic minCardinality(@Nullable Integer minCardinality) {
  ...
  public FeatureSpecificationCharacteristic regex(@Nullable String regex) {
    this.regex = regex;
    return this;
  }
  ...
  public FeatureSpecificationCharacteristic valueType(@Nullable String valueType) {
  ...
  public FeatureSpecificationCharacteristic validFor(@Nullable TimePeriod validFor) {
  ...
  public FeatureSpecificationCharacteristic atBaseType(@Nullable String atBaseType) {
  ...
  public FeatureSpecificationCharacteristic atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public FeatureSpecificationCharacteristic atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public FeatureSpecificationCharacteristic atValueSchemaLocation(@Nullable String atValueSchemaLocation) {
