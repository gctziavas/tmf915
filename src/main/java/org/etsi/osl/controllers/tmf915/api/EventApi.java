...
public interface EventApi {
    ...
    String PATH_CREATE_EVENT = "/topic/{topicId}/event";
    /**
    ...
    default ResponseEntity<Event> createEvent(
        ...
        return getDelegate().createEvent(topicId, event);
    }


    String PATH_LIST_EVENT = "/topic/{topicId}/event";
    /**
    ...
    @RequestMapping(
        ...
        value = EventApi.PATH_LIST_EVENT,
        produces = { "application/json;charset=utf-8" }
    )
    default ResponseEntity<List<Event>> listEvent(
        ...
        return getDelegate().listEvent(topicId, fields, offset, limit);
    }


    String PATH_RETRIEVE_EVENT = "/topic/{topicId}/event/{id}";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = EventApi.PATH_RETRIEVE_EVENT,
        produces = { "application/json;charset=utf-8" }
    )
    default ResponseEntity<Event> retrieveEvent(
        ...
        return getDelegate().retrieveEvent(topicId, id, fields);
    }
