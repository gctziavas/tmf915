...
@Schema(name = "ServiceSpecRelationship", description = "A dependency, substitution or exclusivity relationship between/among service specifications.")
...
public class ServiceSpecRelationship {
   ...
   */
  public ServiceSpecRelationship(String relationshipType) {
    this.relationshipType = relationshipType;
  }

  public ServiceSpecRelationship id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ServiceSpecRelationship href(@Nullable URI href) {
    this.href = href;
    return this;
  }
  ...
  public ServiceSpecRelationship name(@Nullable String name) {
    this.name = name;
    return this;
  }
   ...
   */
  @NotNull 
  @Schema(name = "relationshipType", description = "Type of relationship such as dependency, substitution or exclusivity", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public ServiceSpecRelationship role(@Nullable String role) {
    this.role = role;
    return this;
  }
  ...
  public ServiceSpecRelationship validFor(@Nullable TimePeriod validFor) {
  ...
  public ServiceSpecRelationship atBaseType(@Nullable String atBaseType) {
  ...
  public ServiceSpecRelationship atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ServiceSpecRelationship atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ServiceSpecRelationship atReferredType(@Nullable String atReferredType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, serviceSpecRelationship.id) &&
        ...
        Objects.equals(this.atBaseType, serviceSpecRelationship.atBaseType) &&
        Objects.equals(this.atSchemaLocation, serviceSpecRelationship.atSchemaLocation) &&
        Objects.equals(this.atType, serviceSpecRelationship.atType) &&
        Objects.equals(this.atReferredType, serviceSpecRelationship.atReferredType);
  }
