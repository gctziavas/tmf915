...
import org.etsi.osl.controllers.tmf915.model.TopicChangeEventPayload;
...
@Schema(name = "TopicChangeEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class TopicChangeEvent {

  private @Nullable TopicChangeEventPayload event;
  ...
  public TopicChangeEvent event(@Nullable TopicChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable TopicChangeEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable TopicChangeEventPayload event) {
    this.event = event;
  }

  public TopicChangeEvent eventId(@Nullable String eventId) {
  ...
  public TopicChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public TopicChangeEvent eventType(@Nullable String eventType) {
  ...
  public TopicChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public TopicChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public TopicChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public TopicChangeEvent description(@Nullable String description) {
  ...
  public TopicChangeEvent priority(@Nullable String priority) {
  ...
  public TopicChangeEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public boolean equals(Object o) {
    ...
    TopicChangeEvent topicChangeEvent = (TopicChangeEvent) o;
    return Objects.equals(this.event, topicChangeEvent.event) &&
        Objects.equals(this.eventId, topicChangeEvent.eventId) &&
        Objects.equals(this.eventTime, topicChangeEvent.eventTime) &&
        Objects.equals(this.eventType, topicChangeEvent.eventType) &&
        Objects.equals(this.correlationId, topicChangeEvent.correlationId) &&
        Objects.equals(this.domain, topicChangeEvent.domain) &&
        Objects.equals(this.title, topicChangeEvent.title) &&
        Objects.equals(this.description, topicChangeEvent.description) &&
        Objects.equals(this.priority, topicChangeEvent.priority) &&
        Objects.equals(this.timeOcurred, topicChangeEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopicChangeEvent {\n");
