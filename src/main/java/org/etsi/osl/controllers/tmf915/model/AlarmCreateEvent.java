...
import org.etsi.osl.controllers.tmf915.model.AlarmCreateEventPayload;
...
@Schema(name = "AlarmCreateEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class AlarmCreateEvent {

  private @Nullable AlarmCreateEventPayload event;
  ...
  public AlarmCreateEvent event(@Nullable AlarmCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable AlarmCreateEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable AlarmCreateEventPayload event) {
    this.event = event;
  }

  public AlarmCreateEvent eventId(@Nullable String eventId) {
  ...
  public AlarmCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public AlarmCreateEvent eventType(@Nullable String eventType) {
  ...
  public AlarmCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public AlarmCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public AlarmCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public AlarmCreateEvent description(@Nullable String description) {
  ...
  public AlarmCreateEvent priority(@Nullable String priority) {
  ...
  public AlarmCreateEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.event, alarmCreateEvent.event) &&
