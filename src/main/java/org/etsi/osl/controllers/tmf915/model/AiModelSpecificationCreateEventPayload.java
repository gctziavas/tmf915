...
@Schema(name = "AiModelSpecificationCreateEventPayload", description = "The event data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class AiModelSpecificationCreateEventPayload {

  private @Nullable AiModelSpecification aiModelSpecification;

  public AiModelSpecificationCreateEventPayload aiModelSpecification(@Nullable AiModelSpecification aiModelSpecification) {
  ...
  public boolean equals(Object o) {
    ...
    AiModelSpecificationCreateEventPayload aiModelSpecificationCreateEventPayload = (AiModelSpecificationCreateEventPayload) o;
    return Objects.equals(this.aiModelSpecification, aiModelSpecificationCreateEventPayload.aiModelSpecification);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiModelSpecificationCreateEventPayload {\n");
