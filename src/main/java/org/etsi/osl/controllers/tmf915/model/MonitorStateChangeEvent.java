...
import org.etsi.osl.controllers.tmf915.model.MonitorStateChangeEventPayload;
...
@Schema(name = "MonitorStateChangeEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class MonitorStateChangeEvent {

  private @Nullable MonitorStateChangeEventPayload event;
  ...
  public MonitorStateChangeEvent event(@Nullable MonitorStateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable MonitorStateChangeEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable MonitorStateChangeEventPayload event) {
    this.event = event;
  }

  public MonitorStateChangeEvent eventId(@Nullable String eventId) {
  ...
  public MonitorStateChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public MonitorStateChangeEvent eventType(@Nullable String eventType) {
  ...
  public MonitorStateChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public MonitorStateChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public MonitorStateChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public MonitorStateChangeEvent description(@Nullable String description) {
  ...
  public MonitorStateChangeEvent priority(@Nullable String priority) {
  ...
  public MonitorStateChangeEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
