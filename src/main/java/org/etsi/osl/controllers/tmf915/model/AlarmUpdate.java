...
@Schema(name = "Alarm_Update", description = "This resource represents an alarm supporting the information model defined in ITU-T X.733. Skipped properties: id,href,alarmRaisedTime,sourceSystemId")
@JsonTypeName("Alarm_Update")
...
public class AlarmUpdate {
  ...
  public AlarmUpdate ackState(@Nullable String ackState) {
  ...
  public AlarmUpdate ackSystemId(@Nullable String ackSystemId) {
  ...
  public AlarmUpdate ackUserId(@Nullable String ackUserId) {
  ...
  public AlarmUpdate alarmChangedTime(@Nullable OffsetDateTime alarmChangedTime) {
  ...
  public AlarmUpdate alarmClearedTime(@Nullable OffsetDateTime alarmClearedTime) {
  ...
  public AlarmUpdate alarmDetails(@Nullable String alarmDetails) {
  ...
  public AlarmUpdate alarmEscalation(@Nullable Boolean alarmEscalation) {
  ...
  public AlarmUpdate alarmReportingTime(@Nullable OffsetDateTime alarmReportingTime) {
  ...
  public AlarmUpdate alarmedObjectType(@Nullable String alarmedObjectType) {
  ...
  public AlarmUpdate clearSystemId(@Nullable String clearSystemId) {
  ...
  public AlarmUpdate clearUserId(@Nullable String clearUserId) {
  ...
  public AlarmUpdate externalAlarmId(@Nullable String externalAlarmId) {
  ...
  public AlarmUpdate isRootCause(@Nullable Boolean isRootCause) {
  ...
  public AlarmUpdate plannedOutageIndicator(@Nullable String plannedOutageIndicator) {
  ...
  public AlarmUpdate probableCause(@Nullable String probableCause) {
  ...
  public AlarmUpdate proposedRepairedActions(@Nullable String proposedRepairedActions) {
  ...
  public AlarmUpdate reportingSystemId(@Nullable String reportingSystemId) {
  ...
  public AlarmUpdate serviceAffecting(@Nullable Boolean serviceAffecting) {
  ...
  public AlarmUpdate specificProblem(@Nullable String specificProblem) {
  ...
  public AlarmUpdate state(@Nullable String state) {
    this.state = state;
    return this;
  }
  ...
  public AlarmUpdate affectedService(List<@Valid AffectedService> affectedService) {
  ...
  public AlarmUpdate alarmType(@Nullable AlarmType alarmType) {
  ...
  public AlarmUpdate alarmedObject(@Nullable AlarmedObject alarmedObject) {
  ...
  public AlarmUpdate comment(List<@Valid Comment> comment) {
  ...
  public AlarmUpdate correlatedAlarm(List<@Valid AlarmRef> correlatedAlarm) {
  ...
  public AlarmUpdate crossedThresholdInformation(@Nullable CrossedThresholdInformation crossedThresholdInformation) {
  ...
  public AlarmUpdate parentAlarm(List<@Valid AlarmRef> parentAlarm) {
  ...
  public AlarmUpdate perceivedSeverity(@Nullable PerceivedSeverity perceivedSeverity) {
  ...
  public AlarmUpdate place(List<@Valid RelatedPlaceRefOrValue> place) {
    this.place = place;
    return this;
  }
  ...
  public AlarmUpdate atBaseType(@Nullable String atBaseType) {
  ...
  public AlarmUpdate atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public AlarmUpdate atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ackState, alarmUpdate.ackState) &&
        ...
        Objects.equals(this.atBaseType, alarmUpdate.atBaseType) &&
        Objects.equals(this.atSchemaLocation, alarmUpdate.atSchemaLocation) &&
        Objects.equals(this.atType, alarmUpdate.atType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ackState, ackSystemId, ackUserId, alarmChangedTime, alarmClearedTime, alarmDetails, alarmEscalation, alarmReportingTime, alarmedObjectType, clearSystemId, clearUserId, externalAlarmId, isRootCause, plannedOutageIndicator, probableCause, proposedRepairedActions, reportingSystemId, serviceAffecting, specificProblem, state, affectedService, alarmType, alarmedObject, comment, correlatedAlarm, crossedThresholdInformation, parentAlarm, perceivedSeverity, place, atBaseType, atSchemaLocation, atType);
  }
