...
public class ThresholdRef {
  ...
  public ThresholdRef href(@Nullable URI href) {
    this.href = href;
    return this;
  }
  ...
  public ThresholdRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ThresholdRef atBaseType(@Nullable String atBaseType) {
  ...
  public ThresholdRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ThresholdRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ThresholdRef atReferredType(@Nullable String atReferredType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, thresholdRef.id) &&
        ...
        Objects.equals(this.atType, thresholdRef.atType) &&
