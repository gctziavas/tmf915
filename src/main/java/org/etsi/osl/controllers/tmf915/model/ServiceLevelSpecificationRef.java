...
public class ServiceLevelSpecificationRef {
   ...
   */
  public ServiceLevelSpecificationRef(String id) {
    this.id = id;
  }
  ...
  public ServiceLevelSpecificationRef href(@Nullable URI href) {
    this.href = href;
    return this;
  }
  ...
  public ServiceLevelSpecificationRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ServiceLevelSpecificationRef atBaseType(@Nullable String atBaseType) {
  ...
  public ServiceLevelSpecificationRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ServiceLevelSpecificationRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ServiceLevelSpecificationRef atReferredType(@Nullable String atReferredType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, serviceLevelSpecificationRef.id) &&
        ...
        Objects.equals(this.atBaseType, serviceLevelSpecificationRef.atBaseType) &&
        Objects.equals(this.atSchemaLocation, serviceLevelSpecificationRef.atSchemaLocation) &&
        Objects.equals(this.atType, serviceLevelSpecificationRef.atType) &&
        Objects.equals(this.atReferredType, serviceLevelSpecificationRef.atReferredType);
  }
