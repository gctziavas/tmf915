...
public interface AiContractViolationApi {
    ...
    default AiContractViolationApiDelegate getDelegate() {
        return new AiContractViolationApiDelegate() {};
    }

    String PATH_CREATE_AI_CONTRACT_VIOLATION = "/aiContractViolation";
    /**
    ...
    @RequestMapping(
        ...
        value = AiContractViolationApi.PATH_CREATE_AI_CONTRACT_VIOLATION,
    ...
    default ResponseEntity<AiContractViolation> createAiContractViolation(
        ...
        return getDelegate().createAiContractViolation(aiContractViolation);
    }


    String PATH_LIST_AI_CONTRACT_VIOLATION = "/aiContractViolation";
    /**
    ...
    @RequestMapping(
        ...
        value = AiContractViolationApi.PATH_LIST_AI_CONTRACT_VIOLATION,
        produces = { "application/json;charset=utf-8" }
    )
    default ResponseEntity<List<AiContractViolation>> listAiContractViolation(
        ...
        return getDelegate().listAiContractViolation(fields, offset, limit);
    }


    String PATH_RETRIEVE_AI_CONTRACT_VIOLATION = "/aiContractViolation/{id}";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = AiContractViolationApi.PATH_RETRIEVE_AI_CONTRACT_VIOLATION,
        produces = { "application/json;charset=utf-8" }
    )
    default ResponseEntity<AiContractViolation> retrieveAiContractViolation(
        ...
        return getDelegate().retrieveAiContractViolation(id, fields);
    }
