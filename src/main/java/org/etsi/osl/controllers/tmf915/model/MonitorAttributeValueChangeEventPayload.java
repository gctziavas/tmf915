...
@Schema(name = "MonitorAttributeValueChangeEventPayload", description = "The event data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class MonitorAttributeValueChangeEventPayload {

  private @Nullable Monitor monitor;

  public MonitorAttributeValueChangeEventPayload monitor(@Nullable Monitor monitor) {
