...
import org.etsi.osl.controllers.tmf915.mappers.converters.CharacteristicSpecificationListConverter;
...
public class AiContractSpecification {
  ...
  public AiContractSpecification id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public AiContractSpecification href(@Nullable URI href) {
    this.href = href;
    return this;
  }
  ...
  public AiContractSpecification description(@Nullable String description) {
  ...
  public AiContractSpecification isBundle(@Nullable Boolean isBundle) {
  ...
  public AiContractSpecification lastUpdate(@Nullable OffsetDateTime lastUpdate) {
  ...
  public AiContractSpecification lifecycleStatus(@Nullable String lifecycleStatus) {
  ...
  public AiContractSpecification name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AiContractSpecification version(@Nullable String version) {
  ...
  public AiContractSpecification addAttachmentItem(AttachmentRefOrValue attachmentItem) {
  ...
  public AiContractSpecification addConstraintItem(ConstraintRef constraintItem) {
  ...
  public AiContractSpecification addEntitySpecRelationshipItem(EntitySpecificationRelationship entitySpecRelationshipItem) {
  ...
  public AiContractSpecification addRelatedPartyItem(RelatedParty relatedPartyItem) {
  ...
  public AiContractSpecification addSpecCharacteristicItem(CharacteristicSpecification specCharacteristicItem) {
  ...
  public AiContractSpecification targetEntitySchema(@Nullable TargetEntitySchema targetEntitySchema) {
  ...
  public AiContractSpecification validFor(@Nullable TimePeriod validFor) {
  ...
  public AiContractSpecification atBaseType(@Nullable String atBaseType) {
  ...
  public AiContractSpecification atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public AiContractSpecification atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AiContractSpecification aiContractSpecification = (AiContractSpecification) o;
    return Objects.equals(this.id, aiContractSpecification.id) &&
        Objects.equals(this.href, aiContractSpecification.href) &&
        Objects.equals(this.description, aiContractSpecification.description) &&
        Objects.equals(this.isBundle, aiContractSpecification.isBundle) &&
        Objects.equals(this.lastUpdate, aiContractSpecification.lastUpdate) &&
        Objects.equals(this.lifecycleStatus, aiContractSpecification.lifecycleStatus) &&
        Objects.equals(this.name, aiContractSpecification.name) &&
        Objects.equals(this.version, aiContractSpecification.version) &&
        Objects.equals(this.attachment, aiContractSpecification.attachment) &&
        Objects.equals(this.constraint, aiContractSpecification.constraint) &&
        Objects.equals(this.entitySpecRelationship, aiContractSpecification.entitySpecRelationship) &&
        Objects.equals(this.relatedParty, aiContractSpecification.relatedParty) &&
        Objects.equals(this.specCharacteristic, aiContractSpecification.specCharacteristic) &&
        Objects.equals(this.targetEntitySchema, aiContractSpecification.targetEntitySchema) &&
        Objects.equals(this.validFor, aiContractSpecification.validFor) &&
        Objects.equals(this.atBaseType, aiContractSpecification.atBaseType) &&
        Objects.equals(this.atSchemaLocation, aiContractSpecification.atSchemaLocation) &&
        Objects.equals(this.atType, aiContractSpecification.atType);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiContractSpecification {\n");
