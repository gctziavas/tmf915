...
public class Topic {
  ...
  public Topic id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  @Schema(name = "id", description = "The identifier of the notification.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("id")
  ...
  public Topic href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public Topic contentQuery(@Nullable String contentQuery) {
  ...
  public Topic headerQuery(@Nullable String headerQuery) {
  ...
  public Topic name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Topic atBaseType(@Nullable String atBaseType) {
  ...
  public Topic atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public Topic atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
