...
import org.etsi.osl.controllers.tmf915.model.AiModelCreateEventPayload;
...
@Schema(name = "AiModelCreateEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class AiModelCreateEvent {

  private @Nullable AiModelCreateEventPayload event;
  ...
  public AiModelCreateEvent event(@Nullable AiModelCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable AiModelCreateEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable AiModelCreateEventPayload event) {
    this.event = event;
  }

  public AiModelCreateEvent eventId(@Nullable String eventId) {
  ...
  public AiModelCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public AiModelCreateEvent eventType(@Nullable String eventType) {
  ...
  public AiModelCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public AiModelCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public AiModelCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public AiModelCreateEvent description(@Nullable String description) {
  ...
  public AiModelCreateEvent priority(@Nullable String priority) {
  ...
  public AiModelCreateEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public boolean equals(Object o) {
    ...
    AiModelCreateEvent aiModelCreateEvent = (AiModelCreateEvent) o;
    return Objects.equals(this.event, aiModelCreateEvent.event) &&
        Objects.equals(this.eventId, aiModelCreateEvent.eventId) &&
        Objects.equals(this.eventTime, aiModelCreateEvent.eventTime) &&
        Objects.equals(this.eventType, aiModelCreateEvent.eventType) &&
        Objects.equals(this.correlationId, aiModelCreateEvent.correlationId) &&
        Objects.equals(this.domain, aiModelCreateEvent.domain) &&
        Objects.equals(this.title, aiModelCreateEvent.title) &&
        Objects.equals(this.description, aiModelCreateEvent.description) &&
        Objects.equals(this.priority, aiModelCreateEvent.priority) &&
        Objects.equals(this.timeOcurred, aiModelCreateEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiModelCreateEvent {\n");
