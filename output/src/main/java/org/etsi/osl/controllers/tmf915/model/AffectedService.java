...
public class AffectedService {
  ...
  public AffectedService id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public AffectedService href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  @Schema(name = "href", description = "Provides the identifier of the service affected by the alarm", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("href")
