...
import org.etsi.osl.controllers.tmf915.model.AlarmAttributeValueChangeEventPayload;
...
@Schema(name = "AlarmAttributeValueChangeEvent", description = "The notification data structure")
...
public class AlarmAttributeValueChangeEvent {
  ...
  private @Nullable AlarmAttributeValueChangeEventPayload event;

  public AlarmAttributeValueChangeEvent eventId(@Nullable String eventId) {
  ...
  public AlarmAttributeValueChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public AlarmAttributeValueChangeEvent eventType(@Nullable String eventType) {
  ...
  public AlarmAttributeValueChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public AlarmAttributeValueChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public AlarmAttributeValueChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public AlarmAttributeValueChangeEvent description(@Nullable String description) {
  ...
  public AlarmAttributeValueChangeEvent priority(@Nullable String priority) {
  ...
  public AlarmAttributeValueChangeEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public AlarmAttributeValueChangeEvent fieldPath(@Nullable String fieldPath) {
  ...
  public AlarmAttributeValueChangeEvent event(@Nullable AlarmAttributeValueChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable AlarmAttributeValueChangeEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable AlarmAttributeValueChangeEventPayload event) {
    this.event = event;
  }
