...
import org.etsi.osl.controllers.tmf915.model.RuleDeleteEventPayload;
...
@Schema(name = "RuleDeleteEvent", description = "The notification data structure")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-03-18T18:56:23.275173970Z[Etc/UTC]", comments = "Generator version: 7.21.0-SNAPSHOT")
public class RuleDeleteEvent {

  private @Nullable RuleDeleteEventPayload event;
  ...
  public RuleDeleteEvent event(@Nullable RuleDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable RuleDeleteEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable RuleDeleteEventPayload event) {
    this.event = event;
  }

  public RuleDeleteEvent eventId(@Nullable String eventId) {
  ...
  public RuleDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public RuleDeleteEvent eventType(@Nullable String eventType) {
  ...
  public RuleDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public RuleDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public RuleDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public RuleDeleteEvent description(@Nullable String description) {
  ...
  public RuleDeleteEvent priority(@Nullable String priority) {
  ...
  public RuleDeleteEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public boolean equals(Object o) {
    ...
    RuleDeleteEvent ruleDeleteEvent = (RuleDeleteEvent) o;
    return Objects.equals(this.event, ruleDeleteEvent.event) &&
        Objects.equals(this.eventId, ruleDeleteEvent.eventId) &&
        Objects.equals(this.eventTime, ruleDeleteEvent.eventTime) &&
        Objects.equals(this.eventType, ruleDeleteEvent.eventType) &&
        Objects.equals(this.correlationId, ruleDeleteEvent.correlationId) &&
        Objects.equals(this.domain, ruleDeleteEvent.domain) &&
        Objects.equals(this.title, ruleDeleteEvent.title) &&
        Objects.equals(this.description, ruleDeleteEvent.description) &&
        Objects.equals(this.priority, ruleDeleteEvent.priority) &&
        Objects.equals(this.timeOcurred, ruleDeleteEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class RuleDeleteEvent {\n");
